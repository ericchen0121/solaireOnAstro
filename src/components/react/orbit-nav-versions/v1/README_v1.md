# OrbitNav V1 Component Documentation

> **📦 ARCHIVED VERSION** - This is the original OrbitNav implementation with text labels.  
> To use this version, set `ACTIVE_VERSION = 'v1'` in `orbit-nav-config.ts`  
> Current development is on V2. See `../VERSION_GUIDE.md` for switching instructions.
